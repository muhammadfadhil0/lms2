...
$maintenanceConfig = include 'src/config/maintenance.php';
...
<?php require 'src/component/modal-choose-role.php'; ?>
    ...
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            if (isset($_GET['success'])) {
                ...
                } elseif ($_GET['success'] == 'username_updated') {
                    $newUsername = isset($_GET['new_username']) ? htmlspecialchars($_GET['new_username']) : '';
                    echo 'Username berhasil diperbarui! Silakan login dengan username baru Anda: <strong>' . $newUsername . '</strong>';
                } elseif ($_GET['success'] == 'email_verified') {
                    echo 'Email berhasil diverifikasi! Akun Anda sekarang aktif. Silakan login dengan username dan password Anda.';
                }
            ...
            if (isset($_GET['error'])) {
                ...
                if ($_GET['error'] == 'invalid') {
                    ...
                    echo 'Email Anda belum diverifikasi. <a href="src/front/verify-email.php?email=' . urlencode($email) . '" class="font-semibold underline hover:text-red-800">Klik di sini untuk verifikasi</a>';
            ...
            <p class="mt-10 text-center text-sm/6 text-gray-500">
                ...
                <button class="font-semibold text-orange hover:text-indigo-500" command="show-modal" commandfor="help-login">Bantu saya</button>
            </p>

            <p class="mt-2 text-center text-sm/6 text-gray-500">Belum punya akun? <button class="font-semibold text-orange hover:text-indigo-500" command="show-modal" commandfor="choose-role">Daftar sekarang</button></p>
        </div>
    </div>
