...
class SettingsManager {
    ...
    showDataLoadedIndicator() {
        ...
        indicator.className = 'data-loaded-indicator fixed top-4 right-4 bg-green-500 text-white px-4 py-2 rounded-lg text-sm z-50';
    ...
    setupRealTimeValidation() {
        // Real-time validation could be added here in the future
        // Currently disabled to remove green styling
    }
