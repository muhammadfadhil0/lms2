<el-dialog>
    <dialog id="upload-schedule-modal" aria-labelledby="schedule-dialog-title"
        ...
        <div tabindex="0"
            class="flex min-h-full items-center justify-center p- px-3 text-center focus:outline-none sm:p-0">
            <el-dialog-panel
                ...
                <div class="bg-white px-3 pt-4 pb-4 sm:p-7 sm:pb-5">
                    <div class="sm:flex sm:items-start">
                        <div
                            class="mx-auto flex size-12 bg-blue-100 shrink-0 items-center justify-center rounded-full sm:mx-0 sm:size-12">
                        ...
                        <div class="mt-4 text-center sm:mt-0 sm:ml-5 sm:text-left">
                            <h3 id="schedule-dialog-title" class="text-base font-semibold text-gray-900 sm:text-lg">
                                Upload Jadwal Kelas</h3>
                            <div class="mt-2">
                        ...
                        <div class="space-y-4 sm:space-y-5">
                            <div>
                                <label for="schedule-file"
                                    class="block text-sm font-medium text-gray-700 mb-1.5 sm:text-base sm:mb-2">File
                                    Jadwal</label>
                                <input type="file" id="schedule-file" name="schedule_file"
                                    accept=".pdf,.doc,.docx,.jpg,.jpeg,.png" required class="mt-1 block w-full py-2 px-3 text-sm sm:text-base text-gray-500 border-2 border-gray-300 rounded-md
                                ...
                                <p class="mt-2 text-xs text-gray-500 sm:text-sm">Format yang didukung: PDF, DOC, DOCX,
                                    JPG, PNG (Maks. 10MB)</p>
                            </div>
                        </div>
                    </form>
                    ...
                    <div class="mt-7 sm:mt-8">
                        <h4 class="text-sm font-semibold text-gray-900 mb-3 sm:text-base sm:mb-4">Jadwal yang Sudah
                            Diupload</h4>
                        <div id="existing-schedules"
                            class="space-y-2 sm:space-y-3 max-h-56 sm:max-h-60 overflow-y-auto">
