            ...
            <el-dialog-panel class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all data-closed:translate-y-4 data-closed:opacity-0 data-enter:duration-300 data-enter:ease-out data-leave:duration-200 data-leave:ease-in sm:my-8 sm:w-full sm:max-w-2xl data-closed:sm:translate-y-0 data-closed:sm:scale-95">
                <div class="bg-white px-5 pt-6 pb-5 sm:p-7 sm:pb-5">
                    <div class="sm:flex sm:items-start">
                        <div class="mx-auto flex size-14 bg-blue-100 shrink-0 items-center justify-center rounded-full sm:mx-0 sm:size-12">
                            <span class="ti ti-calendar-plus text-xl text-blue-600"></span>
                        </div>
                        <div class="mt-4 text-center sm:mt-0 sm:ml-5 sm:text-left">
                            <h3 id="schedule-dialog-title" class="text-lg font-semibold text-gray-900">Upload Jadwal Kelas</h3>
                            <div class="mt-2">
                                <p class="text-base text-gray-500">Kelola jadwal kelas untuk siswa</p>
                            </div>
                        </div>
                    </div>

                    <!-- Upload Form -->
                    <form id="upload-schedule-form" class="mt-6" enctype="multipart/form-data">
                        <div class="space-y-5">
                            <div>
                                <label for="schedule-file" class="block text-base font-medium text-gray-700 mb-2">File Jadwal</label>
                                ...
                                <p class="mt-2 text-sm text-gray-500">Format yang didukung: PDF, DOC, DOCX, JPG, PNG (Maks. 10MB)</p>
                            </div>
                        </div>
                    </form>
                    ...
                    <!-- Existing Schedules -->
                    <div class="mt-8">
                        <h4 class="text-base font-semibold text-gray-900 mb-4">Jadwal yang Sudah Diupload</h4>
                        <div id="existing-schedules" class="space-y-3 max-h-60 overflow-y-auto">
                ...
                <div class="bg-gray-50 px-5 py-5 sm:px-6 flex flex-col sm:flex-row-reverse gap-3">
                    ...
                    <button type="button" onclick="closeScheduleModal()"
                        class="w-full sm:w-auto inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-3 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                        Tutup
                    </button>
                </div>
            </el-dialog-panel>
