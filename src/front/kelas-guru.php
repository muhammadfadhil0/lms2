...
<body class="bg-gray-50">
    ...
    <div class="md:ml-64 min-h-screen transition-all duration-300 ease-in-out" data-main-content>
        ...
        <!-- Jumbotron -->
        <div class="relative h-60 lg:h-80 overflow-hidden"
            ...
            <?php if (!empty($detailKelas['gambar_kelas'])): ?>
                <img src="../../<?php echo htmlspecialchars($detailKelas['gambar_kelas']); ?>"
                    ...
                    class="w-full h-full object-cover absolute inset-0" style="z-index: 1;">
                <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-black/20" style="z-index: 2;"></div>
            <?php endif; ?>
            <div class="absolute bottom-4 lg:bottom-6 left-4 lg:left-6 text-white z-30">
                <h1 class="text-2xl lg:text-4xl font-bold leading-tight mb-1">
                    <?php echo htmlspecialchars($detailKelas['namaKelas']); ?>
                </h1>
                <?php if (!empty($detailKelas['deskripsi'])): ?>
                    <p class="text-sm opacity-95 leading-snug">
                        <?php echo nl2br(htmlspecialchars($detailKelas['deskripsi'])); ?>
                    </p>
                <?php else: ?>
                    <p class="text-sm text-gray-200 italic leading-snug">Belum ada deskripsi kelas.</p>
                <?php endif; ?>
            </div>
        </div>
                ...
                <div class="flex-1 lg:w-2/3">
                    ...
                    <div class="md:hidden bg-white rounded-lg p-3 shadow-sm mb-4">
                        <div class="grid grid-cols-4 gap-2">
                            <button type="button" onclick="openClassSettings()"
                                class="group flex flex-col items-center justify-center rounded-lg bg-white border border-gray-200 text-[10px] font-medium text-gray-600 shadow-sm active:scale-95 transition hover:border-orange-300 hover:bg-orange-50 h-20">
                            ...
                            <button type="button" onclick="openScheduleModal()"
                                class="group flex flex-col items-center justify-center rounded-lg bg-white border border-gray-200 text-[10px] font-medium text-gray-600 shadow-sm active:scale-95 transition hover:border-blue-300 hover:bg-blue-50 h-20">
                            ...
                            <button type="button" onclick="openMaterialModal()"
                                class="group flex flex-col items-center justify-center rounded-lg bg-white border border-gray-200 text-[10px] font-medium text-gray-600 shadow-sm active:scale-95 transition hover:border-green-300 hover:bg-green-50 h-20">
                    ...
                    <div class="bg-white rounded-lg p-4 lg:p-6 shadow-sm mb-6">
                        <form id="postForm" enctype="multipart/form-data">
                            <div class="flex items-start space-x-3 lg:space-x-4">
                                <div
                                    class="w-8 h-8 lg:w-10 lg:h-10 rounded-full overflow-hidden flex items-center justify-center flex-shrink-0">
                                    <?php
                                    // Get fresh photo from database
                                    $currentUserPhotoUrl = getUserProfilePhotoUrl($_SESSION['user']['id']);
                                    if ($currentUserPhotoUrl): ?>
                                        <img src="<?php echo htmlspecialchars($currentUserPhotoUrl); ?>" alt="Foto Profil"
                                ...
                                <div class="flex-1">
                                    <textarea id="postTextarea" name="konten"
                                    ...
                                    <div class="flex items-center justify-between mt-4">
                                        <div class="flex space-x-2 lg:space-x-4">
                                            <div class="media-upload-container">
                                                <input type="file" id="mediaInput" name="media[]" multiple
                                                    accept="image/*,video/*" class="media-upload-input">
                                                <label for="mediaInput"
                                                    class="media-upload-label flex items-center text-gray-600 hover:text-orange transition-colors text-sm lg:text-base cursor-pointer">
                                            ...
                                            <div class="file-upload-container">
                                                ...
                                                <label for="fileInput"
                                                    class="file-upload-label flex items-center text-gray-600 hover:text-purple-600 transition-colors text-sm lg:text-base cursor-pointer">
                                        ...
                                        <button type="submit"
                                            class="bg-orange text-white px-4 lg:px-6 py-2 rounded-lg hover:bg-orange-600 transition-colors text-sm lg:text-base">
                                            Posting
                                        </button>
                                    </div>
                                </div>
                ...
                <div class="lg:w-1/3">
                    <div class="sticky top-6">
                        ...
                        <div class="bg-white rounded-lg p-4 lg:p-6 shadow-sm mb-6">
                            ...
                            <div class="space-y-2">
                                <button onclick="openClassSettings()"
                                    class="w-full flex items-center p-3 text-left hover:bg-orange-50 rounded-lg transition-colors border border-transparent hover:border-orange-200">
                                    <i class="ti ti-settings mr-3 text-orange"></i>
                                    <span class="text-sm text-gray-700 font-medium">Pengaturan Kelas</span>
                                </button>
                                <button onclick="openAssignmentReports()"
                                    class="w-full flex items-center p-3 text-left hover:bg-blue-50 rounded-lg transition-colors border border-transparent hover:border-blue-200">
                                ...
                                <button onclick="openMaterialModal()"
                                    class="w-full flex items-center p-3 text-left hover:bg-green-50 rounded-lg transition-colors border border-transparent hover:border-green-200">
                        ...
                        <div class="bg-white rounded-lg p-4 lg:p-6 shadow-sm mb-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <p class="text-xl font-bold text-gray-900">
                                            <?php echo $statistikPostingan['totalPostingan'] ?? 0; ?></p>
    ...
    <?php require '../component/modal-edit-assignment.php'; ?>
    ...
    <script src="../script/edit-assignment-modal.js"></script>
